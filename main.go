...
import (
	"github.com/claudio-navarro-martinez/cursoweb/endpoints"
	"github.com/claudio-navarro-martinez/cursoweb/handlers"
	"net/http"
	"os"
	//"github.com/claudio-navarro-martinez/middleware"
...
func main() {
	...
	//shttp.Handle("/", middleware.ContextExampleHandler(middleware.PanicRecoveryHandler(ghandlers.LoggingHandler(os.Stdout, r))))
